...
(SELECT 
    ...
    CASE WHEN icd10_code IN ('C20','C18.9')
 THEN 'C19' ELSE icd10_code END AS icd10code,
         icd10_code
    FROM
        diagnosis_concept_view
    WHERE
        icd10_code IN ('C20','C18.9')) first_answers
...
FROM
(SELECT 
    CASE WHEN concept_full_name IN ('Malignant neoplasm of other and unspecified parts of mouth','Malignant neoplasm of nasopharynx',
...
'Malignant neoplasm of gum','Malignant neoplasm of floor of mouth','Malignant neoplasm of palate','Malignant neoplasm of parotid gland',
...
'Malignant neoplasm of nasal cavity and middle ear','Malignant neoplasm of Bones of skull and face','Malignant neoplasm of mandible')
	THEN 'Head & neck cancer' ELSE concept_full_name END AS answer_name,
    CASE WHEN icd10_code IN ('C06','C11','C00.0','C01','C02','C03','C04','C05','C07','C08','C09','C10','C14','C30','C41.0','C41.1')
 THEN 'C49.0' ELSE icd10_code END AS icd10code,icd10_code
    FROM diagnosis_concept_view
    WHERE icd10_code IN ('C06','C11','C00.0','C01','C02','C03','C04','C05','C07','C08','C09','C10','C14','C30','C41.0','C41.1')) first_answers
...
'C85','C56','C67','C11','C76')) first_answers        
    ...
    INNER JOIN obs o1 ON o.encounter_id = o1.encounter_id AND o1.obs_group_id = o.obs_group_id AND o1.value_coded = 18
    INNER JOIN concept_name cn ON o.concept_id = cn.concept_id AND cn.concept_name_type = 'FULLY_SPECIFIED' AND cn.name IN ('Coded Diagnosis') AND o.voided = 0 AND cn.voided = 0
    JOIN diagnosis_concept_view dcv ON dcv.concept_id = o.value_coded AND dcv.icd10_code IN ('C50.9','C53','C34','C15.9','D13.1','C73','C22','C25','C79.5','C23','C06',
'C85','C56','C67','C11','C76')
    WHERE p.voided = 0) first_concept ON first_concept.icd10_code = first_answers.icd10_code
        LEFT OUTER JOIN
